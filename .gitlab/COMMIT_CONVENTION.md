...
```
[ci] add hugo build job on merge requests
- modular pipeline under .gitlab/workflows/
- validate on MRs, build artifacts on main
```
...
- Reference issues in bullet points when helpful (e.g. `Closes #123`)
